       ...
       <ul id="menu">
		...
		<li><a href="#">Administration</a>
			<ul>
				...
				<li>
					<a href="${contextPath}/subscription/new">Subscription Management</a>				
				</li>
			</ul>
		</li>
		<li><a href="#">Articles</a>
			<ul>
				<li><a href="${contextPath}/article/new">Create New Article</a></li>							
				<li><a href="${contextPath}/article/list">View Existing Articles</a></li>							
				<li><a href="${contextPath}/comments/list">Approve Comments</a></li>
			</ul>
		</li>	
		<li><a href="#">Menu2</a>
			<ul>
